...
QVariant ModulesModel::data(const QModelIndex& index, int role) const {
  ...
  if (role == Qt::DisplayRole) {
    switch (index.column()) {
    case 0:
      return QString::fromStdString(binja::rewind::core::mapping::path_basename(module.path));
    case 1:
      return QString("0x%1").arg(module.base, 0, 16);
    case 2:
      return QString("0x%1").arg(module.size, 0, 16);
    case 3:
      return QString::fromStdString(binja::rewind::core::format::permission_string(module.permissions));
    default:
      break;
    }
  }
...
void ModulesModel::setModules(const std::vector<binja::rewind::core::model::TraceModule>& modules) {
  beginResetModel();
  m_modules = modules;
  endResetModel();
}
...
void SessionView::setSummary(const binja::rewind::core::model::TraceSummary& summary) {
...
void SessionView::setModules(const std::vector<binja::rewind::core::model::TraceModule>& modules) {
