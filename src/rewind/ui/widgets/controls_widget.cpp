...
RewindControlsWidget::RewindControlsWidget(QWidget* parent) : QToolBar(parent) {
  ...
  action_play_forward_ = make_action(
      this, "Play Forward", binja::rewind::ui::make_icon(":/rewind/icons/play.svg", green),
      with_keybinding("Play Forward", binja::rewind::ui::action_name(binja::rewind::ui::ActionId::Resume))
  );
  action_pause_ = make_action(
      this, "Pause", binja::rewind::ui::make_icon(":/rewind/icons/pause.svg", white),
      with_keybinding("Pause", binja::rewind::ui::action_name(binja::rewind::ui::ActionId::Pause))
  );
  action_step_in_ = make_action(
      this, "Step In", binja::rewind::ui::make_icon(":/rewind/icons/arrow-down-to-dot.svg", cyan),
      with_keybinding("Step In", binja::rewind::ui::action_name(binja::rewind::ui::ActionId::StepInto))
  );
  action_step_over_ = make_action(
      this, "Step Over", binja::rewind::ui::make_icon(":/rewind/icons/redo-dot.svg", cyan),
      with_keybinding("Step Over", binja::rewind::ui::action_name(binja::rewind::ui::ActionId::StepOver))
  );
  action_step_out_ = make_action(
      this, "Step Out", binja::rewind::ui::make_icon(":/rewind/icons/arrow-up-from-dot.svg", cyan),
      with_keybinding("Step Out", binja::rewind::ui::action_name(binja::rewind::ui::ActionId::StepReturn))
  );
  action_step_back_ = make_action(
      this, "Step Back", binja::rewind::ui::make_icon(":/rewind/icons/undo-dot.svg", red),
      with_keybinding("Step Back", binja::rewind::ui::action_name(binja::rewind::ui::ActionId::StepIntoBackwards))
  );
  action_play_backward_ = make_action(
      this, "Play Backward", binja::rewind::ui::make_icon(":/rewind/icons/play-back.svg", red),
      with_keybinding("Play Backward", binja::rewind::ui::action_name(binja::rewind::ui::ActionId::GoBackwards))
  );
  action_run_start_ = make_action(
      this, "Run to Start", binja::rewind::ui::make_icon(":/rewind/icons/rotate-ccw.svg", red), "Run to Start"
  );
  action_load_trace_ = make_action(
      this, "Load Trace", binja::rewind::ui::make_icon(":/rewind/icons/folder-open.svg", white), "Load Trace"
  );
  action_clear_trace_ =
      make_action(this, "Clear Trace", binja::rewind::ui::make_icon(":/rewind/icons/trash-2.svg", red), "Clear Trace");
