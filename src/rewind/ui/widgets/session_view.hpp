...
public:
  ...
  void setModules(const std::vector<binja::rewind::core::model::TraceModule>& modules);
  void clear();

private:
  std::vector<binja::rewind::core::model::TraceModule> m_modules;
};
...
public:
  ...
  void setSummary(const binja::rewind::core::model::TraceSummary& summary);
  void setModules(const std::vector<binja::rewind::core::model::TraceModule>& modules);
  void clear();
